...
| `{topic}/button/1` | Short press | `{"device": "...", "button": "1", "version": "1.0.0", "uptime": 123}` |
| `{topic}/button/2` | Long press | `{"device": "...", "button": "2", "version": "1.0.0", "uptime": 123}` |
| `{topic}/button/3` | Very long press | `{"device": "...", "button": "3", "version": "1.0.0", "uptime": 123}` |
